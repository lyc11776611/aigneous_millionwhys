          ...
          <div className="bg-white rounded-3xl shadow-2xl p-6 md:p-10">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                <span
                  className={`inline-block px-3 py-1 rounded-full text-xs font-semibold border ${difficultyConfig[currentQuestion.difficulty].color
                    }`}
                >
                  {language === 'en'
                ...
                (choice, index) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-300 ${showAsCorrect
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div
                          className={`flex-shrink-0 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${showAsCorrect
                        ...
                        {/* Choice text */}
                        <span
                          className={`text-base md:text-lg ${showAsCorrect || showAsIncorrect ? 'font-semibold' : ''
                            }`}
                        >
                          {choice}
                        </span>
            ...
            {showFeedback && (
              <div className="flex gap-3">
                <button
                  ...
                  className={`${allQuestionsCompleted ? 'w-full' : 'flex-1'
      ...
      {showExplanationModal && selectedAnswer !== null && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <div
              className={`p-6 rounded-t-3xl ${isCorrect
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={handleShareQuestion}
                  className="flex-1 bg-blue-50 text-blue-600 border-2 border-blue-100 hover:bg-blue-100 font-bold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2"
                >
                  <span>📤</span>
                  {language === 'en' ? 'Share this Fact' : '分享这个知识'}
                </button>

                <button
                  onClick={() => setShowExplanationModal(false)}
                  className="flex-1 bg-gradient-to-r from-[#D94E33] to-[#FF6B52] hover:from-[#FF6B52] hover:to-[#D94E33] text-white font-bold py-3 px-6 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl"
                >
